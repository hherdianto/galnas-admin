            ...
            <li class="c-header-nav-item dropdown d-md-down-none mx-2">
                <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
                   aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="badge badge-pill badge-info" id="notification-badge" style="display: none"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0" id="notification-container">
{{--                    <a class="dropdown-item text-center border-top" href="#"><strong>View all messages</strong></a>--}}
{{--                    <a class="dropdown-item text-center border-top" onclick="">--}}
{{--                        <strong>Bersihkan</strong>--}}
{{--                    </a>--}}
                </div>
            </li>
            <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#"
                    ...
                    <div class="c-avatar"><img class="c-avatar-img"
                                               src="{{ env('APP_URL', '') }}/assets/img/avatars/galnas_round.png"
            ...
            <ol class="breadcrumb border-0 m-0">
                ...
                @for($i = 1; $i <= count(Request::segments()); $i++)
                    ...
                    @if($i < count(Request::segments()))
                            <li class="breadcrumb-item"><a href="{{ url($segments) }}">{{ Request::segment($i) }}</a></li>
                    @else
